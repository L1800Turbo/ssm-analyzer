...
from analyzer_core.config.ssm_model import CurrentSelectedDevice, RomIdTableEntry_256kb, RomIdTableEntry_512kb, RomIdTableInfo
...
class SsmFunctionEmulator:
    ...
    def __collect_romid_tables(self):
        ...
        for current_device in self.rom_cfg.selectable_devices:
            ...
            romid_tbl = RomIdTableAnalyzer(emulator.mem, current_table_info)
            ...
            for current_romid in current_table_info.entries:
                ...
                current_selected_device = self.rom_cfg.address_by_name("current_selected_device")
    ...
    def __execute_attach_cu_specific_addresses(self, 
        ...
        current_romid.possible_hidden_menuitems_pointer = emulator.read16(self.rom_cfg.address_by_name('possible_hidden_menuitems_pointer'))
